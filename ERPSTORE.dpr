...
uses
  ...
  unit_consulta_padrao in 'FONTES\Repositorio\unit_consulta_padrao.pas' {frmBaseSearch},
  ...
  unit_cadastro_padrao in 'FONTES\Repositorio\unit_cadastro_padrao.pas' {frmBaseRegister},
  ...
  uBaseInterfaces in 'FONTES\Interfaces\uBaseInterfaces.pas',
  uBaseClass in 'FONTES\Classes\uBaseClass.pas',
  uCliente in 'FONTES\Classes\uCliente.pas',
  uFormLinker in 'LIB\uFormLinker.pas',
  uProduto in 'FONTES\Classes\uProduto.pas',
  uEstoque in 'FONTES\Classes\uEstoque.pas',
  unit_cadastro_vendas in 'FONTES\Cadastros\unit_cadastro_vendas.pas' {form_cadastro_vendas},
  uVendas in 'FONTES\Classes\uVendas.pas';

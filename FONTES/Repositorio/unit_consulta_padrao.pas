...
type
  ...
  public
    { Public declarations }
    procedure CriaForm(const Nome: string; FormMode: TFormMode);
    var
    NomeTabela : string;
    NomeForm: string;
    NomeReport: string;
...
procedure Tform_consulta_padrao.CriaForm(const Nome: string; FormMode: TFormMode);
var
  Tela: TForm;
